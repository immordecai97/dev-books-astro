import { c as createComponent, m as maybeRenderHead, a as renderTemplate, e as createAstro, b as addAttribute, r as renderComponent } from './astro/server_DC6VVYoI.mjs';
...
}, "C:/Users/castm/Documents/stalin/projects/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} title="Comprar libro en Amazon" target="_blank" rel="noopener noreferrer" class="text-balance inline-flex gap-2 items-center bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 text-black font-bold py-2 px-4 rounded-lg border border-yellow-500 transition duration-200 ease-in-out hover:scale-105 justify-center text-center">
Comprar en Amazon ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "C:/Users/castm/Documents/stalin/projects/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/castm/Documents/stalin/projects/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
